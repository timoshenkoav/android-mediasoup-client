...
namespace mediasoupclient {
    ...
    static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetNativeId(JNIEnv *env, jlong
    consumer);
    ...
    static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetProducerId(JNIEnv *env, jlong
    consumer);
    ...
    static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetKind(JNIEnv *env, jlong consumer);
    ...
    static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetRtpParameters(JNIEnv *env, jlong
    consumer);
    ...
    static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetAppData(JNIEnv *env, jlong
    consumer);
    ...
    static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetStats(JNIEnv *env, jlong
    consumer);
    ...
    static void Java_Listener_onTransportClose(JNIEnv *env, const webrtc::JavaRef<jobject> &obj,
                                               const webrtc::JavaRef<jobject> &consumer) {
    ...
    static webrtc::ScopedJavaLocalRef<jobject> Java_Consumer_Constructor(JNIEnv *env, jlong
    nativeConsumer) {
