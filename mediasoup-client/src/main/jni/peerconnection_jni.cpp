...
namespace mediasoupclient {
    ...
    static jlong
    JNI_PeerConnection_GetNativePeerConnection(JNIEnv *env, const JavaParamRef<jobject> &j_pc) {
        MSC_TRACE();
    ...
    static ScopedJavaLocalRef<jstring> JNI_PeerConnection_CreateOffer(
        ...
        std::unique_ptr<webrtc::MediaConstraints> constraints =
                webrtc::jni::JavaToNativeMediaConstraints(env, webrtc::JavaParamRef<jobject>(
                        j_constraints));
    ...
    static ScopedJavaLocalRef<jobject> JNI_PeerConnection_AddTransceiverOfType(
        ...
        auto media_type =
                webrtc::jni::JavaToNativeMediaType(env,
                                                   webrtc::JavaParamRef<jobject>(j_media_type));
        webrtc::RTCErrorOr<rtc::scoped_refptr<webrtc::RtpTransceiverInterface>> result =
